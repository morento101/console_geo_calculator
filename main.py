    ...
    while True:
        ...
        if category == '1':
            ...
            task = input('\nОбчислити:\n'
                         ...
                         '16. Відносну нев\'язку, знаючи координати початкової та кінцевої точок, периметр P, ΣΔΧпр і '
                         'ΣΔyпр\n'
                         '17. Абс. лін. нев\'язку зімкнутого ходу, маючи координати початкової та кінцевої точки, ∆Хпр '
                         ' і ∆Yпр'
                         '18. Абс. лін. нев\'язку розімкнутого ходу, маючи координати початкової та кінцевої точки, '
                         '∆Хпр і ∆Yпр'
                         '-->')
