    ...
    while True:
        ...
        if category == '1':
            ...
            task = input('\nОбчислити:\n' +
                         ...
                         '7. Колову криву К, маючи радіус R і кут повороту\n'
                         '8. Відстань від пікету до точки нульових робіт по x\n'
                         '9. Відстань від пікету до точки нулбових робіт по y\n'
                         '10. Криву К при тангенсі Т, домірі Д, бісектрисі Б\n'
                         '11. Кут повороту, маючи радіус R і тангенс\n'
                         '12. Криву К, маючи тангенс Т і бісектрису Б\n'
                         '13. Криву при радіусі R і кут повороту\n'
                         '14. Бісектрису, маючи тангенс Т і радіус R\n'
